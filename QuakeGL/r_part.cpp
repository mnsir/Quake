...
void R_InitParticles()
{
    ...
    if (i)
    {
        r_numparticles = (int)(std::atoi(com_argv[i + 1]));
...
void R_EntityParticles(entity_t * ent)
{
    ...
    {
        double angle = cl.time * avelocities[i][0];
        double sy = sin(angle);
        double cy = cos(angle);
        ...
        constexpr double dist = 64;
        constexpr double beamlength = 16;
