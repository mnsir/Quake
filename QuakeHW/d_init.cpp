...
cvar_t d_subdiv16 = {(char*)"d_subdiv16", (char*)"1"};
cvar_t d_mipcap = {(char*)"d_mipcap", (char*)"0"};
...
{
	// this_ function is only required if the CPU doesn't have direct access to the
	...
	// and will call this_ function before swapping buffers
