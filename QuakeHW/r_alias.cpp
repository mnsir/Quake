...
// FIXME: shouldn't be needed (is needed for patch
...
qboolean R_AliasCheckBBox(void)
{
	...
	if (zclipped)
	{
		// organize points by edges, use edges to get new_ points (possible trivial
		// reject)
		for (i = 0; i < 12; i++)
		{
			// edge endpoints
...
void R_AliasSetUpTransform(int trivial_accept)
{
	...
	// TODO: can do this_ with simple matrix rearrangement
	...
	// FIXME: make this_ work for clipped case too?
	if (trivial_accept)
	{
		for (i = 0; i < 4; i++)
		{
