...
void CL_SignonReply()
{
	...
	case 2:
		...
		MSG_WriteByte(&cls.message, clc_stringcmd);
		sprintf(str, (char*)"spawn %s", cls.spawnparms);
...
void CL_PrintEntities_f()
{
	...
	for (i = 0, ent = cl_entities; i < cl.num_entities; i++, ent++)
	{
		...
		Con_Printf((char*)"%s:%2i  (%5.1f,%5.1f,%5.1f) [%5.1f %5.1f %5.1f]\n"
		           , ent->model->GetName().c_str(), ent->frame, ent->origin[0], ent->origin[1], ent->origin[2], ent->angles[0],
