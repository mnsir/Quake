...
char* svc_strings[] =
{
	...
	(char*)"svc_setangle", // [vec3] set the view angle to this_ absolute value
...
void CL_ParseServerInfo()
{
	...
	cl.scores = static_cast<scoreboard_t*>(Hunk_AllocName(cl.maxclients * sizeof*cl.scores, (char*)"scores"));
...
void CL_ParseUpdate(int bits)
{
	...
	if (model != ent->model)
	{
		...
		if (model)
		{
			if (model->GetSyncType() == synctype_t::ST_RAND)
...
Server information pertaining to this_ client only
==================
*/
