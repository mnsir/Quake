...
void Cbuf_Execute(void)
{
	...
	while (cmd_text.cursize)
	{
		...
		// this_ is necessary because commands (exec, alias) can insert data at the
...
Creates a new_ command that executes a command string (possibly ; seperated)
===============
*/
...
void Cmd_TokenizeString(char* text)
{
	...
	while (1)
	{
		...
		if (*text == '\n')
		{
			// a new_line seperates commands in the buffer
			text++;
			break;
		}
