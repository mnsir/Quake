...
void Loop_SearchForHosts(qboolean xmit)
{
	...
	if (Q_strcmp(hostname.string, (char*)"UNNAMED") == 0)
		Q_strcpy(hostcache[0].name, (char*)"local");
	else
	...
	Q_strcpy(hostcache[0].cname, (char*)"local");
}


qsocket_t* Loop_Connect(char* host)
{
	if (Q_strcmp(host, (char*)"local") != 0)
		return NULL;
	...
	if (!loop_client)
	{
		...
		Q_strcpy(loop_client->address, (char*)"localhost");
	}
	...
	if (!loop_server)
	{
		...
		Q_strcpy(loop_server->address, (char*)"LOCAL");
	}
