...
Called by drivers when a new_ communications endpoint is required
...
qsocket_t* NET_NewQSocket(void)
{
	...
	Q_strcpy(sock->address, (char*)"UNSET ADDRESS");
...
static void NET_Port_f(void)
{
	...
	if (listening)
	{
		// force a change to the new_ port
		Cbuf_AddText((char*)"listen 0\n");
		Cbuf_AddText((char*)"listen 1\n");
	}
}
