...
int WIPX_Read(int socket, uint8_t* buf, int len, struct qsockaddr* addr);
int WIPX_Write(int socket, uint8_t* buf, int len, struct qsockaddr* addr);
int WIPX_Broadcast(int socket, uint8_t* buf, int len);
