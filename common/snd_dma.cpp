...
void S_Init(void)
{
	...
	known_sfx = static_cast<sfx_t*>(Hunk_AllocName(MAX_SFX * sizeof(sfx_t), (char*)"sfx_t"));
	num_sfx = 0;
	...
	if (fakedma)
	{
		shm = static_cast<volatile dma_t*>(Hunk_AllocName(sizeof*shm, (char*)"shm"));
		shm->splitbuffer = 0;
		shm->samplebits = 16;
		shm->speed = 22050;
		shm->channels = 2;
		...
		shm->buffer = static_cast<unsigned char*>(Hunk_AllocName(1 << 16, (char*)"shmbuf"));
	}
...
void S_StartSound(int entnum, int entchannel, sfx_t* sfx, vec3_t origin, float fvol, float attenuation)
{
	...
	// if an identical sound has also been started this_ frame, offset the pos
...
void S_Update_(void)
{
	...
	{
		//Con_Printf ((char*)"S_Update_ : overflow\n");
