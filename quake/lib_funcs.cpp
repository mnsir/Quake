...
Con_GetTotalLinesFunc Con_GetTotalLines = NULL;
VID_GetHeightFunc VID_GetHeight = NULL;
Con_GetBackScrollFunc Con_GetBackScroll = NULL;
Con_SetBackScrollFunc Con_SetBackScroll = NULL;
CL_IsDemoPlayBackFunc CL_IsDemoPlayBack = NULL;
Con_IsForcedUpFunc Con_IsForcedUp = NULL;