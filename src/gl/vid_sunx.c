...
int p_mouse_x;
int p_mouse_y;
qboolean	mouse_grabbed = false_; // we grab it when console is up
...
qboolean				mouse_in_window = false_;
...
//			printf("config notify\n");
		...
		case ClientMessage:
			...
			break;
		case EnterNotify:
			mouse_in_window = true_;
			break;
		case LeaveNotify:
			mouse_in_window = false_;
			break;
